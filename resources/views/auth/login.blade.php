                        ...
                        @csrf
							<fieldset>
								<div class="form-group">
                                    <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="ایمیل" name="email" type="email" autofocus>
                                    @if ($errors->has('email'))
								...
								<div class="form-group">
									<input class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="رمز عبور" name="password" type="password" value="">
								...
								<div class="checkbox">
									<label><input name="remember" type="checkbox" value="مرا به خاطر بسپار"  {{ old('remember') ? 'checked' : '' }}>مرا به خاطر بسپار</label>
								</div>
